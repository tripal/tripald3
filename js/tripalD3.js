...
tripalD3 = {
   ...
   */
   drawFigure: function(data, options) {
    ...
    else if (options.chartType ==='horizontalscatter') {
      success = tripalD3.scatterHorizontal.drawScatterHorizontal(svg, data, options.chartOptions);
    }
    else if (options.chartType ==='simplelineplot') {
      success = tripalD3.simpleLinePlot.drawSimpleLinePlot(svg, data, options.chartOptions);
    }
