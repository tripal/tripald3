...
<script type="text/javascript">
  Drupal.behaviors.tripalD3testing = {
    attach: function (context, settings) {
      ...
      ['simplepie', 'simpledonut', 'multidonut', 'simplebar', 'histogram'].forEach(function(element) {
        ...
        if (element == 'simplepie' || element == 'simpledonut' || element == 'simplebar' || element == 'histogram') {
